...
--
-- Host: localhost:3306
-- Generation Time: Jul 09, 2024 at 02:08 AM
...
CREATE TABLE `bill` (
  ...
  `acc_id` int NOT NULL,
  `bill_status` int NOT NULL DEFAULT '1' COMMENT '1: Đang giao hàng\r\n2: Đã nhận hàng\r\n0: Đã hủy'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `bill` (`bill_id`, `fullname`, `phone`, `address`, `date_order`, `bill_total`, `acc_id`, `bill_status`) VALUES
(1, 'Nguyễn Thùy Dung', '0378296292', 'Hạ Long, Quảng Ninh', '2024-07-03 15:58:31', '499.000', 3, 1);
...
(11, 'test news2', '1720469831_4658257.jpg', '123');
...
(1, 'Màu đỏ', '16x16cm', '99.000', 13, 1, 1),
(2, 'Màu đỏ', '14x14cm', '89.000', 11, 1, 1),
(3, 'Màu đỏ', '12x12cm', '79.000', 12, 1, 1),
(4, 'Màu trắng', '16x16cm', '99.000', 25, 1, 1),
(5, 'Màu trắng', '14x14cm', '89.000', 21, 1, 1),
(6, 'Màu trắng', '12x12cm', '79.000', 19, 1, 1),
(7, 'Trắng', '1m', '199.000', 22, 2, 1),
(8, 'Hồng nude', '10x30cm', '86.000', 12, 3, 1),
(9, 'Vàng trắng', 'R20cm', '159.000', 30, 4, 1),
(10, 'Đỏ', 'R15cm', '99.000', 20, 5, 1),
(11, 'Nâu gỗ', 'R20cm', '175.000', 32, 6, 1),
(12, 'Trắng', 'R20cmxH30cm', '199.000', 30, 7, 1),
(13, 'Xanh ghi', '12x12cm', '167.000', 50, 8, 1),
(14, 'Xanh bơ', '5x50cm', '79.000', 45, 9, 1),
(15, 'Trắng sứ', 'R10xR15cm', '88.000', 16, 10, 1),
(16, 'Xám ghi', 'R8cm', '66.000', 45, 11, 1),
(17, 'Đen sứ', '1L', '78.000', 20, 12, 1),
(18, 'Nâu gỗ', 'R30xH50cm', '399.000', 25, 13, 1),
(19, 'Vàng gỗ', '30x20x50cm', '499.000', 30, 14, 1),
(20, 'Đen', '500ml', '59.000', 20, 15, 1),
(21, 'Xanh cổ vịt', 'R10cm', '69.000', 55, 16, 1),
