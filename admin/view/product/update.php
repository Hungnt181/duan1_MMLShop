            ...
            <form action="" class="pb-5 mt-4 ms-4 me-4" method="POSt" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="">
                        ...
                        <img src="../img/product/<?= $info->pro_image ?>" alt="" style="width:200px; margin: 20px 0;" name="existing_image">
                    </div>
                    <div class="">
                        <label for="inputEmail4" class="form-label">Tên sản phẩm</label>
                        <input type="text" class="form-control rounded-0" id="inputEmail4" placeholder="Nhập tên sản phẩm" name="pro_name" value="<?= $info->pro_name ?>">
                    </div>
                    <div class="">
                        <label for="inputPassword5" class="form-label">Mô tả</label>
                        <textarea id="" cols="30" rows="3" class="form-control" placeholder="Mô tả" name="pro_description">
